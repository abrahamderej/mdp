...
import edu.miu.quizapp.utils.AppUtil.*
...
class HomeFragment : BaseFragment() {
    ...
    private var homeViewModel: ScoreView? = null
    ...
    override fun onCreateView(
        ...
        homeViewModel = ViewModelProvider(this).get(ScoreView::class.java)
        ...
        launch {
            context?.let {
                questions = QuizDB(it).getQuizDao().getAllQuizzes()
                changeQuestion(view)
            }
        }
