...
class ContactFragment : Fragment(R.layout.fragment_contact) {
    ...
    private fun onLinkedInClicked() {
        ...
        intent.putExtra(getString(R.string.intent_key), getString(R.string.linkedin_account))
        startActivity(intent)
    }

    private fun onGithubClicked() {
        val intent = Intent(context, WebActivity::class.java)
        intent.putExtra(getString(R.string.intent_key), getString(R.string.github_account))
        startActivity(intent)
    }
}