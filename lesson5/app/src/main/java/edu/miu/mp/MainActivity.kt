...
class MainActivity : AppCompatActivity() {
    private val registeredUsers = mutableListOf<User>(User("Abraham", "Abera", "abraham@gmail.com", "abraham"),
    User("Solomon", "Mola", "solo@gmail.com", "solomon"),
    User("John", "Dohe", "dohe@gmail.com", "john"),
    User("Kirubel", "sdur", "kirubel@gmail.com", "kirubel"),
    User("Girma", "taso", "girma@gmail.com", "girma"))
